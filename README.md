...
3. The code can be used to analyse dark-energy models, such as flat &LambdaCDM, ΛCDM, flat wCDM, wCDM, and flat w₀wₐCDM. The model to be analyzed can be selected in the main program.
