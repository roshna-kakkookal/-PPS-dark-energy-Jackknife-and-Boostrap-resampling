...
3. The code can be used to analyse dark-energy models, such as flat &Lambda;CDM, &Lambda;CDM, flat wCDM, wCDM, and flat w<sub>0</sub>w<sub>a</sub>CDM. The model to be analyzed can be selected in the main program.
